...
knitr::include_graphics("images/moz-banner.png", error = F)
```
...
Welcome to the course "Introduction to R for applied epidemiologists", offered for free by **[Applied Epi](www.appliedepi.org)** - a nonprofit organisation supporting frontline epidemiologists and public health practitioners through open-source tools, training, and support.  

Applied Epi created the free [Epidemiologist R Handbook](www.epiRhandbook.com), runs a [Community forums]
...
linelist <- import(here("dat", "linelist_cleaned.rds"))   # import data and save as named object
```

...
This tutorial draws from chapters of our free [Epidemiologist R handbook](https://epirhandbook.com/en/) such as [ggplot basics](https://epirhandbook.com/en/ggplot-basics.html), [ggplot tips](https://epirhandbook.com/en/ggplot-tips.html), and [epidemic curves](https://epirhandbook.com/en/epidemic-curves.html).  
...
[Source: Epi R Handbook](https://epirhandbook.com)
...
You can read more in our Basics tutorial and in the [Epi R Handbook](https://epirhandbook.com/en/import-and-export.html) about how RStudio projects, the {here} package, and the {rio} package can be efficiently used together to make the data import process very easy!

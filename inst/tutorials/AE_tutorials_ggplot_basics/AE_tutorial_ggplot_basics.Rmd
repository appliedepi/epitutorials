...
#### Tutorial 3: Introduction to data visualization
...
::: {}
**These self-paced tutorials:**

 
* Introduce you to the basics of R coding  
* R on your computer is **not** required  
* Help is available at our public  
[Applied Epi Community](http://community.appliedepi.org) forum  
...
We offer a comprehensive ecosystem of R training, tools, and support, including our free [Epidemiologist R Handbook](www.epiRhandbook.com) which has helped over **175,000 people** learn R and remains a vital resource for many practitioners.  
...
* **[Live R courses](www.appliedepi.org)**  
* **[Self-paced interactive tutorials](https://training.appliedepi.org)**  
...
linelist %>% 
   drop_na(gender, hospital_clean) %>%  # drop rows that are missing (NA) gender and hospital 
   filter(hospital_clean != "Missing") %>%    # drop rows where hospital is "Missing" 
...
Congratulation on finishing this tutorial!  If you have extra time, consider completing the extra exercises below. Otherwise, we welcome you to advance to the next tutorial in the series. Please also see the tutorial that focuses on more complex plotting techniques and common epidemiological plots.  
